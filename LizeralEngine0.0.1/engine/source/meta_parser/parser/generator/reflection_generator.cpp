...
namespace Generator
{
    ...
    void ReflectionGenerator::prepareStatus(std::string path)
    {
        ...
        // std::cout << "[DEBUG] Root path: " << m_root_path << std::endl;
        // std::cout << "[DEBUG] Template path: " << m_root_path + "/../template/" << std::endl;
    ...
    int ReflectionGenerator::generate(std::string path, SchemaMoudle schema)
    {
        ...
        {
            // std::cout << "[DEBUG] Class: " << class_temp->getClassName() << std::endl;
            // std::cout << "[DEBUG] Should compile: " << class_temp->shouldCompileFilds() << std::endl;
            // std::cout << "[DEBUG] Number of fields: " << class_temp->m_fields.size() << std::endl;
