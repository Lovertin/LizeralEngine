    ...
    public:
        ...
        */
        ...
        Vector3 operator*(const Vector3& rhs) const
        {
            ...
            {
                prod[row_index] =
                    m_mat[row_index][0] * rhs.getX() + m_mat[row_index][1] * rhs.getY() + m_mat[row_index][2] * rhs.getZ();
            }
            return prod;
        }
        ...
        friend Vector3 operator*(const Vector3& point, const Matrix3x3& rhs)
        {
            ...
            for (size_t row_index = 0; row_index < 3; row_index++)
            {
                prod[row_index] = point.getX() * rhs.m_mat[0][row_index] + 
                                  point.getY() * rhs.m_mat[1][row_index] +
                                  point.getZ() * rhs.m_mat[2][row_index];
            }
            return prod;
        }
        ...
        static Matrix3x3 scale(const Vector3& scale)
        {
            ...
            mat.m_mat[0][0] = scale.getX();
            mat.m_mat[1][1] = scale.getY();
            mat.m_mat[2][2] = scale.getZ();
